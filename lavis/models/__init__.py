...
from lavis.models.blip2_models.blip2_t5_costom import Blip2T5_CUSTOM # ADD costom model
...
__all__ = [
    ...
    "Blip2OPT",
    "Blip2T5",
    "Blip2T5_CUSTOM", # ADD costom model
    "Blip2T5Instruct",
    "Blip2VicunaInstruct",
    "PNPVQA",
    "Img2PromptVQA",
...
def load_model_and_preprocess(name, model_type, is_eval=False, device="cpu"):
    ...
    print('My log : lavis/models/__init__.py/load_model_and_preprocess:207/ ¥n model_cls = registry.get_model_class(name) ')
    print('My log : model_cls : ', model_cls)
