...
model, vis_processors, _ = load_model_and_preprocess(
    name='blip2_t5', #blip2_t5, blip2_t5_custom
...
print('=====image1=====')
# 画像の読み込み
raw_image = Image.open('/taiga/moonshot/blip2_moonshot/images/merlion.png').convert('RGB')
...
print('=====image2=====')
# 画像の読み込み
raw_image = Image.open('/taiga/moonshot/blip2_moonshot/images/flant5.png').convert('RGB')
image = vis_processors['eval'](raw_image).unsqueeze(0).to(device)
#print('vis_processors output : ', image)
#print('vis_processors output.shape : ', image.shape)
...
print('=====image3=====')
# 画像の読み込み
raw_image = Image.open('/taiga/moonshot/blip2_moonshot/images/stage2.png').convert('RGB')
image = vis_processors['eval'](raw_image).unsqueeze(0).to(device)
#print('vis_processors output : ', image)
#print('vis_processors output.shape : ', image.shape)
...
print('=====image4=====')
# 画像の読み込み
raw_image = Image.open('/taiga/moonshot/blip2_moonshot/images/sample_figure1.png').convert('RGB')
image = vis_processors['eval'](raw_image).unsqueeze(0).to(device)
#print('vis_processors output : ', image)
#print('vis_processors output.shape : ', image.shape)
